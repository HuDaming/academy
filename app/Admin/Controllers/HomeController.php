...
use Encore\Admin\Widgets\StoreInfoBox;
...
class HomeController extends Controller
{
    public function index()
    {
        ...
        return Admin::content(function (Content $content) {
            if (Admin::user()->roles[0]->slug == 'administrator') {
            ...
            } else if (Admin::user()->roles[0]->slug == 'store') {
                ...
                $content->row(function ($row) {
                    ...
                    $row->column(12, new StoreInfoBox($store->name, 'book', 'aqua', '/admin/stores/1/edit', $store->introduce, $store->users));
                });
